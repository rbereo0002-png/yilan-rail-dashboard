export const YilanRules = {
  commonRules: [
    ...
    {id:'designRiskPlan',group:'配套成果',name:'設計階段施工風險評估實施計畫書',triggerType:'awardDate',days:60,dayType:'calendar',predecessor:'award',contractRule:true,deadlineClass:'contract',conditional:false,note:'契約生效（決標）日起60日內提送；工作啟始日與簽約日不影響本項起算'},
    {id:'basic',group:'設計',name:'基本設計成果初稿',triggerType:'approvalOf',triggerRef:'execPlan',days:150,dayType:'calendar',predecessor:'execPlan',contractRule:true,deadlineClass:'dynamic',conditional:false,pcmReviewDays:14,pcmReviewContract:true,payment:'工程設計20%（累計40%）',note:'執行服務計畫書核定後150日內提送；PCM基本設計諮詢及審查14日'},
    ...
    {id:'final',group:'設計',name:'期末設計成果初稿',triggerType:'basicApprovalOrNotice',triggerRef:'basic',days:300,dayType:'calendar',predecessor:'basic',contractRule:true,deadlineClass:'dynamic',conditional:false,pcmReviewDays:14,pcmReviewContract:true,payment:'工程設計40%（累計85%）',note:'基本設計核定後或甲方通知日起300日內提送；PCM細部設計諮詢及審查14日'},
    ...
    {id:'tender',group:'招標',name:'招標文件成果核定',triggerType:'externalDate',dateField:'tenderApprovalDate',predecessor:'final',contractRule:false,deadlineClass:'external',conditional:false,pcmReviewDays:10,pcmReviewContract:true,payment:'工程設計5%（累計90%）',note:'草擬招標文件送達PCM後10日內完成諮詢及審查並送甲方；最終核定日仍另行登錄'},
