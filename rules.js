export const YilanRules = {
  commonRules: [
    ...
    {id:'designRiskPlan',group:'配套成果',name:'設計階段施工風險評估執行服務計畫書',triggerType:'awardDate',days:30,dayType:'calendar',predecessor:'award',contractRule:true,deadlineClass:'contract',conditional:false,note:'契約生效（決標）後30日內提送；工作啟始日不影響本項起算'},
